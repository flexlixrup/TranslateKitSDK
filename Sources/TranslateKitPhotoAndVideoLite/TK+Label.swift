...
extension TK.Label {
   /// "Albums" - Use for displaying photo albums
   public static var albums: String {
      String(localized: "TK.Label.albums", defaultValue: "Albums", bundle: .module, comment: "Use for displaying photo albums")
   }
   ...
   public static var effects: String {
      String(localized: "TK.Label.effects", defaultValue: "Effects", bundle: .module, comment: "Use for applying effects to an image or video")
   }
   ...
   public static var fileName: String {
      String(localized: "TK.Label.fileName", defaultValue: "File Name", bundle: .module, comment: "Use for displaying the file name of a media file")
   }

   /// "File Size" - Use for displaying the size of a media file
   public static var fileSize: String {
      String(localized: "TK.Label.fileSize", defaultValue: "File Size", bundle: .module, comment: "Use for displaying the size of a media file")
   }

   /// "Filters" - Use for applying filters to an image or video
   public static var filters: String {
      String(localized: "TK.Label.filters", defaultValue: "Filters", bundle: .module, comment: "Use for applying filters to an image or video")
   }

   /// "Gallery" - Use for accessing the photo or video gallery
   public static var gallery: String {
      String(localized: "TK.Label.gallery", defaultValue: "Gallery", bundle: .module, comment: "Use for accessing the photo or video gallery")
   }

   /// "Height" - Use for displaying the height of an image or video
   public static var height: String {
      String(localized: "TK.Label.height", defaultValue: "Height", bundle: .module, comment: "Use for displaying the height of an image or video")
   }

   /// "Image" - Use for displaying or selecting an image
   public static var image: String {
      String(localized: "TK.Label.image", defaultValue: "Image", bundle: .module, comment: "Use for displaying or selecting an image")
   }

   /// "Library" - Use for accessing the media library
   public static var library: String {
      String(localized: "TK.Label.library", defaultValue: "Library", bundle: .module, comment: "Use for accessing the media library")
   }

   /// "Media" - Use for referring to media files (photos, videos, etc.)
   public static var media: String {
      String(localized: "TK.Label.media", defaultValue: "Media", bundle: .module, comment: "Use for referring to media files (photos, videos, etc.)")
   }

   /// "Mode" - Use for selecting different modes or settings
   public static var mode: String {
      String(localized: "TK.Label.mode", defaultValue: "Mode", bundle: .module, comment: "Use for selecting different modes or settings")
   }

   /// "Photos" - Use for displaying photos or photo-related content
   public static var photos: String {
      String(localized: "TK.Label.photos", defaultValue: "Photos", bundle: .module, comment: "Use for displaying photos or photo-related content")
   }

   /// "Playback" - Use for controlling media playback
   public static var playback: String {
      String(localized: "TK.Label.playback", defaultValue: "Playback", bundle: .module, comment: "Use for controlling media playback")
   }
   ...
   public static var preview: String {
      String(localized: "TK.Label.preview", defaultValue: "Preview", bundle: .module, comment: "Use for previewing a photo, video, or effect")
   }
   ...
   public static var size: String {
      String(localized: "TK.Label.size", defaultValue: "Size", bundle: .module, comment: "Use for displaying the size of an image or video")
   }
   ...
   public static var width: String {
      String(localized: "TK.Label.width", defaultValue: "Width", bundle: .module, comment: "Use for displaying the width of an image or video")
   }
}
