...
extension TK.Label {
   ...
   public static var billingStatus: String {
      String(localized: "TK.Label.billingStatus", defaultValue: "Billing Status", bundle: .module, comment: "Use when showing the payment or billing status")
   }

   /// "Billable Hours" - Use when tracking hours that are billable to a client
   public static var billableHours: String {
      String(localized: "TK.Label.billableHours", defaultValue: "Billable Hours", bundle: .module, comment: "Use when tracking hours that are billable to a client")
   }

   /// "Business Hours" - Use for specifying the hours a business is open
   public static var businessHours: String {
      String(localized: "TK.Label.businessHours", defaultValue: "Business Hours", bundle: .module, comment: "Use for specifying the hours a business is open")
   }
   ...
   public static var client: String {
      String(localized: "TK.Label.client", defaultValue: "Client", bundle: .module, comment: "Use when referring to a single customer or business partner")
   }

   /// "Clients" - Use when referring to multiple customers or business partners
   public static var clients: String {
      String(localized: "TK.Label.clients", defaultValue: "Clients", bundle: .module, comment: "Use when referring to multiple customers or business partners")
   }
   ...
   public static var completionDate: String {
      String(localized: "TK.Label.completionDate", defaultValue: "Completion Date", bundle: .module, comment: "Use when showing the date a project or task is due to be completed")
   }
   ...
   public static var creditCard: String {
      String(localized: "TK.Label.creditCard", defaultValue: "Credit Card", bundle: .module, comment: "Use when referring to payment information via credit card")
   }

   /// "Currency" - Use when showing the monetary unit or currency type
   public static var currency: String {
      String(localized: "TK.Label.currency", defaultValue: "Currency", bundle: .module, comment: "Use when showing the monetary unit or currency type")
   }
   ...
   public static var dueDate: String {
      String(localized: "TK.Label.dueDate", defaultValue: "Due Date", bundle: .module, comment: "Use when showing the date by which a task or payment is due")
   }
   ...
   public static var expense: String {
      String(localized: "TK.Label.expense", defaultValue: "Expense", bundle: .module, comment: "Use when referring to a single business-related expense")
   }

   /// "Expenses" - Use when referring to multiple business-related expenses
   public static var expenses: String {
      String(localized: "TK.Label.expenses", defaultValue: "Expenses", bundle: .module, comment: "Use when referring to multiple business-related expenses")
   }

   /// "Invoice Number" - Use for referencing the unique identifier of an invoice
   public static var invoiceNumber: String {
      String(localized: "TK.Label.invoiceNumber", defaultValue: "Invoice Number", bundle: .module, comment: "Use for referencing the unique identifier of an invoice")
   }

   /// "Job Title" - Use when referring to a person's job position or role
   public static var jobTitle: String {
      String(localized: "TK.Label.jobTitle", defaultValue: "Job Title", bundle: .module, comment: "Use when referring to a person's job position or role")
   }
   ...
   public static var organization: String {
      String(localized: "TK.Label.organization", defaultValue: "Organization", bundle: .module, comment: "Use for company or group organization details")
   }

   /// "Payment Method" - Use for selecting or displaying payment method options
   public static var paymentMethod: String {
      String(localized: "TK.Label.paymentMethod", defaultValue: "Payment Method", bundle: .module, comment: "Use for selecting or displaying payment method options")
   }

   /// "Payment Status" - Use when indicating the status of a payment (e.g., paid, pending)
   public static var paymentStatus: String {
      String(localized: "TK.Label.paymentStatus", defaultValue: "Payment Status", bundle: .module, comment: "Use when indicating the status of a payment (e.g., paid, pending)")
   }

   /// "Project Status" - Use when showing the current status of a project
   public static var projectStatus: String {
      String(localized: "TK.Label.projectStatus", defaultValue: "Project Status", bundle: .module, comment: "Use when showing the current status of a project")
   }

   /// "Revenue" - Use for displaying the income or earnings of a business
   public static var revenue: String {
      String(localized: "TK.Label.revenue", defaultValue: "Revenue", bundle: .module, comment: "Use for displaying the income or earnings of a business")
   }

   /// "Transaction History" - Use for showing past financial transactions or records
   public static var transactionHistory: String {
      String(localized: "TK.Label.transactionHistory", defaultValue: "Transaction History", bundle: .module, comment: "Use for showing past financial transactions or records")
   }
