...
extension TK.Action {
   ...
   public static var analyze: String {
      String(localized: "TK.Action.analyze", defaultValue: "Analyze", bundle: .module, comment: "Use for analyzing medical data or results")
   }
   ...
   public static var diagnose: String {
      String(localized: "TK.Action.diagnose", defaultValue: "Diagnose", bundle: .module, comment: "Use for diagnosing a medical condition")
   }

   /// "Export Data" - Use for exporting medical data
   public static var exportData: String {
      String(localized: "TK.Action.exportData", defaultValue: "Export Data", bundle: .module, comment: "Use for exporting medical data")
   }

   /// "Export PDF" - Use for exporting a medical report as a PDF
   public static var exportPDF: String {
      String(localized: "TK.Action.exportPDF", defaultValue: "Export PDF", bundle: .module, comment: "Use for exporting a medical report as a PDF")
   }
   ...
   public static var generateReport: String {
      String(localized: "TK.Action.generateReport", defaultValue: "Generate Report", bundle: .module, comment: "Use for generating a medical report")
   }
   ...
   public static var logSymptom: String {
      String(localized: "TK.Action.logSymptom", defaultValue: "Log Symptom", bundle: .module, comment: "Use for documenting medical symptoms")
   }
   ...
   public static var measure: String {
      String(localized: "TK.Action.measure", defaultValue: "Measure", bundle: .module, comment: "Use for taking a medical measurement")
   }

   /// "Monitor" - Use for monitoring health conditions or progress
   public static var monitor: String {
      String(localized: "TK.Action.monitor", defaultValue: "Monitor", bundle: .module, comment: "Use for monitoring health conditions or progress")
   }

   /// "Print Report" - Use for printing a medical report
   public static var printReport: String {
      String(localized: "TK.Action.printReport", defaultValue: "Print Report", bundle: .module, comment: "Use for printing a medical report")
   }

   /// "Record" - Use for recording medical data or information
   public static var record: String {
      String(localized: "TK.Action.record", defaultValue: "Record", bundle: .module, comment: "Use for recording medical data or information")
   }
   ...
   public static var requestData: String {
      String(localized: "TK.Action.requestData", defaultValue: "Request Data", bundle: .module, comment: "Use for requesting medical data or records")
   }
   ...
   public static var schedule: String {
      String(localized: "TK.Action.schedule", defaultValue: "Schedule", bundle: .module, comment: "Use for scheduling a medical event or appointment")
   }
   ...
   public static var shareReport: String {
      String(localized: "TK.Action.shareReport", defaultValue: "Share Report", bundle: .module, comment: "Use for sharing a medical report")
   }
   ...
   public static var submitReport: String {
      String(localized: "TK.Action.submitReport", defaultValue: "Submit Report", bundle: .module, comment: "Use for submitting a medical report")
   }
   ...
   public static var track: String {
      String(localized: "TK.Action.track", defaultValue: "Track", bundle: .module, comment: "Use for tracking medical conditions or health metrics")
   }
