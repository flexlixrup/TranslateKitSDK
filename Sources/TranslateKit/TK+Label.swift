...
extension TK {
   ...
   public enum Label {
      ...
      public static var current: String {
         #tkm("Current", c: "Use for indicating present state or selection")
      }

      /// "Custom" - Use for user-defined settings or preferences
      public static var custom: String {
         #tkm("Custom", c: "Use for user-defined settings or preferences")
      }

      /// "Data" - Use for information storage and management
      public static var data: String {
         #tkm("Data", c: "Use for information storage and management")
      }
      ...
      public static var details: String {
         #tkm("Details", c: "Item information section title")
      }

      /// "Disabled" - Use to indicate when a feature is turned off
      public static var disabled: String {
         #tkm("Disabled", c: "Use to indicate when a feature is turned off")
      }
      ...
      public static var end: String {
         #tkm("End", c: "Noun – Use to label the end of something")
      }
      ...
      public static var file: String {
         #tkm("File", c: "Use for document or media file references")
      }
      ...
      public static var info: String {
         #tkm("Info", c: "Use for additional information or details")
      }
      ...
      public static var menu: String {
         #tkm("Menu", c: "Use for navigation or option lists")
      }
      ...
      public static var new: String {
         #tkm("New", c: "Use to label recently added items")
      }

      /// "None" - Use for empty or null states
      public static var none: String {
         #tkm("None", c: "Use for empty or null states")
      }
      ...
      public static var pending: String {
         #tkm("Pending", c: "Use for items awaiting action or approval")
      }
      ...
      public static var preview: String {
         #tkm("Preview", c: "Use for viewing content before finalizing")
      }
      ...
      public static var search: String {
         #tkm("Search", c: "Noun – Use for input fields related to finding content")
      }
      ...
      public static var selected: String {
         #tkm("Selected", c: "Use for indicating chosen items")
      }
      ...
      public static var start: String {
         #tkm("Start", c: "Noun – Use to label the beginning of processes or activities")
      }
      ...
      public static var type: String {
         #tkm("Type", c: "Use for categorizing or classifying items")
      }
