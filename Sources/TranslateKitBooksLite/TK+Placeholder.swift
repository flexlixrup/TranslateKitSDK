...
extension TK.Placeholder {
   ...
   public static var addNoteHereDots: String {
      String(localized: "TK.Placeholder.addNoteHereDots", defaultValue: "Add a note here…", bundle: .module, comment: "Placeholder for adding a note")
   }

   /// "Add quote…" - Placeholder for adding a quote
   public static var addQuoteDots: String {
      String(localized: "TK.Placeholder.addQuoteDots", defaultValue: "Add quote…", bundle: .module, comment: "Placeholder for adding a quote")
   }

   /// "Add review…" - Placeholder for adding a review
   public static var addReviewDots: String {
      String(localized: "TK.Placeholder.addReviewDots", defaultValue: "Add review…", bundle: .module, comment: "Placeholder for adding a review")
   }

   /// "Add tags…" - Placeholder for adding tags
   public static var addTagsDots: String {
      String(localized: "TK.Placeholder.addTagsDots", defaultValue: "Add tags…", bundle: .module, comment: "Placeholder for adding tags")
   }
   ...
   public static var enterGenreDots: String {
      String(localized: "TK.Placeholder.enterGenreDots", defaultValue: "Enter genre…", bundle: .module, comment: "Placeholder for entering the genre")
   }

   /// "Enter ISBN…" - Placeholder for entering the ISBN
   public static var enterIsbnDots: String {
      String(localized: "TK.Placeholder.enterIsbnDots", defaultValue: "Enter ISBN…", bundle: .module, comment: "Placeholder for entering the ISBN")
   }
   ...
   public static var enterQuoteDots: String {
      String(localized: "TK.Placeholder.enterQuoteDots", defaultValue: "Enter quote…", bundle: .module, comment: "Placeholder for entering a quote")
   }
