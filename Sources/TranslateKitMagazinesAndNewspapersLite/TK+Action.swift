...
extension TK.Action {
   ...
   public static var listenToArticle: String {
      String(localized: "TK.Action.listenToArticle", defaultValue: "Listen to Article", bundle: .module, comment: "Use when listening to an article in audio format")
   }

   /// "Open in Browser" - Use when opening a link or page in a web browser
   public static var openInBrowser: String {
      String(localized: "TK.Action.openInBrowser", defaultValue: "Open in Browser", bundle: .module, comment: "Use when opening a link or page in a web browser")
   }
   ...
   public static var readLater: String {
      String(localized: "TK.Action.readLater", defaultValue: "Read Later", bundle: .module, comment: "Use when saving an article or content for later reading")
   }
   ...
   public static var reportContent: String {
      String(localized: "TK.Action.reportContent", defaultValue: "Report Content", bundle: .module, comment: "Use when reporting inappropriate or harmful content")
   }

   /// "Report Issue" - Use when submitting a bug or technical issue report
   public static var reportIssue: String {
      String(localized: "TK.Action.reportIssue", defaultValue: "Report Issue", bundle: .module, comment: "Use when submitting a bug or technical issue report")
   }

   /// "Save Article" - Use when saving an article for later reference
   public static var saveArticle: String {
      String(localized: "TK.Action.saveArticle", defaultValue: "Save Article", bundle: .module, comment: "Use when saving an article for later reference")
   }

   /// "Save for Later" - Use when saving content for future access
   public static var saveForLater: String {
      String(localized: "TK.Action.saveForLater", defaultValue: "Save for Later", bundle: .module, comment: "Use when saving content for future access")
   }

   /// "Share Document" - Use when sharing a document with others
   public static var shareDocument: String {
      String(localized: "TK.Action.shareDocument", defaultValue: "Share Document", bundle: .module, comment: "Use when sharing a document with others")
   }

   /// "Share Story" - Use when sharing a story or news item with others
   public static var shareStory: String {
      String(localized: "TK.Action.shareStory", defaultValue: "Share Story", bundle: .module, comment: "Use when sharing a story or news item with others")
   }

   /// "Subscribe" - Use when subscribing to a service, publication, or content
   public static var subscribe: String {
      String(localized: "TK.Action.subscribe", defaultValue: "Subscribe", bundle: .module, comment: "Use when subscribing to a service, publication, or content")
   }
   ...
   public static var translate: String {
      String(localized: "TK.Action.translate", defaultValue: "Translate", bundle: .module, comment: "Use when translating content from one language to another")
   }
   ...
   public static var unsubscribe: String {
      String(localized: "TK.Action.unsubscribe", defaultValue: "Unsubscribe", bundle: .module, comment: "Use when canceling a subscription to a service or publication")
   }

   /// "View Breaking News" - Use when viewing the latest breaking news updates
   public static var viewBreakingNews: String {
      String(localized: "TK.Action.viewBreakingNews", defaultValue: "View Breaking News", bundle: .module, comment: "Use when viewing the latest breaking news updates")
   }
}
